CREATE TABLE Servers (
    ...
    PublishedAt DATETIMEOFFSET NOT NULL DEFAULT SYSDATETIMEOFFSET(),
    ...
    CONSTRAINT CHK_Servers_PublishedAtReasonable CHECK (PublishedAt >= '2020-01-01' AND PublishedAt <= DATEADD(DAY, 1, SYSDATETIMEOFFSET()))
);
...
CREATE INDEX IDX_Servers_PublishedAt ON Servers(PublishedAt DESC);
GO;
